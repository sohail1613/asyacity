    ...
    <div className="py-20 bg-[#f8f5ee] dark:bg-background-dark">
      <div className="container-custom max-w-6xl">
        <div className="max-w-4xl mx-auto text-center mb-14">
          <p className="eyebrow text-secondary mb-4">ASYA CITY</p>
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-surface-dark p-8 md:p-12 shadow-soft border-t-4 border-secondary space-y-5 text-text-light dark:text-text-dark-light leading-relaxed">
          {isEnglish ? (
            <>
        ...
        <div className="mt-14">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {principles.map(([title, description], index) => (
              <article key={title} className="bg-white dark:bg-surface-dark p-6 shadow-soft border-l-4 border-secondary">
        ...
        <div className="mt-14 bg-primary-dark text-white p-8 md:p-12 text-center">
