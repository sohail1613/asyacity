      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            {/* Info Box */}
            <div className="bg-surface dark:bg-surface-dark p-6 rounded-3xl border border-border/80 dark:border-dark-border shadow-soft space-y-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3.5 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-bold py-4 px-6 rounded-lg shadow-medium hover:shadow-hard hover:-translate-y-0.5 transition-all duration-300"
            >
