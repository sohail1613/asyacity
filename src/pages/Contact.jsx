    ...
    <div className="py-20">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg border border-border dark:border-dark-border bg-background dark:bg-background-dark text-text dark:text-text-dark focus:outline-none focus:ring-2 focus:ring-secondary"
                    placeholder={isEnglish ? 'Your phone number' : 'Telefon numaranız'}
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-text dark:text-text-dark mb-1">
          ...
          {/* Contact Info */}
          <div>
            <div className="bg-surface dark:bg-surface-dark p-8 rounded-2xl shadow-soft border border-border dark:border-dark-border mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-text-light dark:text-text-dark-light text-sm">
                      Ankara, Türkiye
                    </div>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-text-light dark:text-text-dark-light text-sm">
                      {process.env.REACT_APP_PHONE || '0850 123 45 67'}
                    </div>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-105"
            >
              ...
              {isEnglish ? 'Message on WhatsApp' : 'WhatsApp\'tan Yazın'}
            </a>
          </div>
        </div>
      </div>
