        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3 text-sm">
                ...
                <a href={`mailto:${SITE_CONFIG.company.email}`} className="text-white/70 hover:text-secondary transition-colors">
          ...
          <div>
            ...
            <a href={SITE_CONFIG.developer.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/70 hover:text-secondary transition-colors text-sm">
              <span>LinkedIn</span>
              <span aria-hidden="true"><ArrowUpRight stroke={2}/> </span>
            </a>
          </div>
        </div>
      </div>
